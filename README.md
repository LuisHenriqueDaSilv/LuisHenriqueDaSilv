    ...
    <table width="100%" align="center">
        <tr>
            <td width="25%" align="center" style="text-align: center;">
                <h3>📦 Repositórios</h3>
                <p style="font-size: 24px;"><strong>35</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>💾 Total de Commits</h3>
                <p style="font-size: 24px;"><strong>668</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>🔄 Pull Requests</h3>
                <p style="font-size: 24px;"><strong>5</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
...
<div align="center">
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 176<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/LuisHenriqueDaSilv/commit/0db3d6f4132895fbd65218caaa3d8b3909222377" title="docs: update latest repos in README">docs: update latest repos in README</a>
    </p>
</div>
</td>
