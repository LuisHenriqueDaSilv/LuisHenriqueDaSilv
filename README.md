    ...
    <table width="100%" align="center">
        <tr>
            <td width="25%" align="center" style="text-align: center;">
                <h3>📦 Repositórios</h3>
                <p style="font-size: 24px;"><strong>36</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>💾 Total de Commits</h3>
                <p style="font-size: 24px;"><strong>824</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>🔄 Pull Requests</h3>
                <p style="font-size: 24px;"><strong>29</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
...
<div align="center">
    ...
    <br/>
    <strong><a href="https://github.com/LuisHenriqueDaSilv/ISCTools-backend">ISCTools-backend</a></strong>
    <br/>
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 19<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/ISCTools-backend/commit/ad84de6722b85b6cebdf5ec8454221b7a1f0e14d" title="fix(infra): remove app volume in dock...">fix(infra): remove app volume in dock...</a>
    </p>
</div>
</td>
...
<div align="center">
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 58<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/ISCTools/commit/7b4215d8dbca835efb7e705485068c7a146624f2" title="Merge pull request #7 from LuisHenriq...">Merge pull request #7 from LuisHenriq...</a>
    </p>
</div>
</td>
...
<div align="center">
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 295<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/LuisHenriqueDaSilv/commit/3e3120754bbcd89b89405197b7325bd0036e241b" title="docs: update latest repos in README">docs: update latest repos in README</a>
    </p>
</div>
</td>
  </tr>
...
<td width="33%">
<div align="center">
    <a href="https://github.com/LuisHenriqueDaSilv/IAExpertAcademy.machine_learning_data_science">
    ...
    <br/>
    <strong><a href="https://github.com/LuisHenriqueDaSilv/IAExpertAcademy.machine_learning_data_science">IAExpertAcademy.machine_learning_data_science</a></strong>
    <br/>
    <p align="center" style="font-size: 12px; height: 40px; overflow: hidden;">Sem descrição</p>
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 1<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/IAExpertAcademy.machine_learning_data_science/commit/3323430c3fe28b09cbb0cf4393391b1fb83964dd" title="first commit">first commit</a>
    </p>
</div>
</td>
