    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td width="25%" align="center" style="text-align: center;">
                ...
                <p style="font-size: 24px;"><strong>583</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>🔄 Pull Requests</h3>
...
<div align="center">
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 92<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/LuisHenriqueDaSilv/commit/47bd6086da0debc94feb00c1b8f574e0c15a3cf3" title="docs: update latest repos in README">docs: update latest repos in README</a>
    </p>
</div>
</td>
