    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td width="25%" align="center" style="text-align: center;">
                ...
                <p style="font-size: 24px;"><strong>847</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>🔄 Pull Requests</h3>
...
<div align="center">
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 315<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/LuisHenriqueDaSilv/commit/81e901d1f5cd333869076308afa10c72c3be6a76" title="docs: update latest repos in README">docs: update latest repos in README</a>
    </p>
</div>
</td>
