    ...
    <table width="100%" align="center">
        <tr>
            ...
            <td width="25%" align="center" style="text-align: center;">
                ...
                <p style="font-size: 24px;"><strong>645</strong></p>
            </td>
            <td width="25%" align="center" style="text-align: center;">
                <h3>🔄 Pull Requests</h3>
...
<div align="center">
    ...
    <p align="left" style="font-size: 11px;">
        📄 <strong>Commits:</strong> 154<br/>
        📝 <strong>Último:</strong> <a href="https://github.com/LuisHenriqueDaSilv/LuisHenriqueDaSilv/commit/efe9d04c04d18d6c2e60b73bd80492250741c7f4" title="docs: update latest repos in README">docs: update latest repos in README</a>
    </p>
</div>
</td>
